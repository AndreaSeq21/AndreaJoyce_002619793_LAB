...
public class ViewJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, -1, 40));

        fieldObservationId1.setEnabled(false);
        add(fieldObservationId1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 60, 90, 30));

        jLabel2.setText("ID");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 30, 20));

        jLabel3.setText("Blood Pressure");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 70, 20));
        add(fieldBloodPressure1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, 90, 30));
        add(fieldTemperature1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 90, 30));
        ...
        add(updateObservationButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, -1, 30));
