...
public class CreateJPanel extends javax.swing.JPanel {
    ...
    private void packageIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_packageIdFocusLost
        // TODO add your handling code here:
                String packageIdValue = String.valueOf(packageId.getText());
        
        if(packageIdValue.isEmpty()) {
           JOptionPane.showMessageDialog(null, "Please fill the package Id");
            this.validate = true;
        } else {
            this.validate = false;
        }
    ...
    private void packageWeightFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_packageWeightFocusLost
        // TODO add your handling code here:
                String packageWeightValue = String.valueOf(packageWeight.getText());
        
        if(packageWeightValue.isEmpty()) {
           JOptionPane.showMessageDialog(null, "Please fill the package Weight Value");
            this.validate = true;
        } else {
            this.validate = false;
        }
    ...
    private void customerIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_customerIdFocusLost
        // TODO add your handling code here:
        String customerIdValue = String.valueOf(customerId.getText());
        
        if(customerIdValue.isEmpty()) {
           JOptionPane.showMessageDialog(null, "Please fill the customer Id Value");
            this.validate = true;
        } else {
            this.validate = false;
        }
    ...
    private void productIdFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_productIdFocusLost
        // TODO add your handling code here:
          String productIdValue = String.valueOf(productId.getText());
        
        if(productIdValue.isEmpty()) {
           JOptionPane.showMessageDialog(null, "Please fill the product Id Value");
            this.validate = true;
        } else {
            this.validate = false;
        }
    ...
    private void productNameFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_productNameFocusLost
        ...
        if(productNameValue.isEmpty()) {
           JOptionPane.showMessageDialog(null, "Please fill the product name value");
            this.validate = true;
        } else {
            this.validate = false;
        }
    ...
    private void productPriceFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_productPriceFocusLost
        // TODO add your handling code here:
              String productPriceValue = String.valueOf(productPrice.getText());
        
        if(productPriceValue.isEmpty()) {
           JOptionPane.showMessageDialog(null, "Please fill the product price value");
            this.validate = true;
        } else {
            this.validate = false;
        }
